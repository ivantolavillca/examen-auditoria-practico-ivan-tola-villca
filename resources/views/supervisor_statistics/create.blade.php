                ...
                <div class="row">
                    <div class="col-md-12 col-lg-8 offset-lg-2">
                        <div class="widget">
                            ...
                            <br>
                                <h3 class="widget-title">NOMBRE: IVAN TOLA VILLCA  C.I.: 7088751 LP</h3>
                                <h4 class="widget-title">Estadistica</h4>
                            </header><!-- .widget-header -->
                            <hr class="widget-separator">
                            <div class="widget-body">
                                <form method="GET" action="{{url('supervisor/statistics')}}/{{ app('request')->input('id_agent') }}" enctype="multipart/form-data">
